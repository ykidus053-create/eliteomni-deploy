...
class CrossEncoderTrainer(BaseTrainer):
    ...
    Important attributes:
        ...
        - **model**: Always points to the :class:`~sentence_transformers.cross_encoder.model.CrossEncoder` model to be trained.
        ...
        - **place_model_on_device**: Whether or not to automatically place the model on the device - it will be set
          ...
          :attr:`~sentence_transformers.cross_encoder.training_args.CrossEncoderTrainingArguments.place_model_on_device` is overridden to return ``False``.
        - **is_in_train**: Whether or not a model is currently running :meth:`~sentence_transformers.cross_encoder.trainer.CrossEncoderTrainer.train` (e.g. when :meth:`~sentence_transformers.cross_encoder.trainer.CrossEncoderTrainer.evaluate` is called while
          in :meth:`~sentence_transformers.cross_encoder.trainer.CrossEncoderTrainer.train`)

    End-to-end example:

        - `Training and Finetuning Reranker Models <https://huggingface.co/blog/train-reranker>`_: end-to-end training example with benchmarks against the base model and other reranker models.
